...
/**
 * Defines administrator user role name.
 */
define('USER_ADMINISTRATOR_ROLE_NAME', 'administrator');

/**
 * Defines Editor user role name.
 */
define('USER_EDITOR_ROLE_NAME', 'editor');
...
/**
 * Defines Topic vocabulary name.
 */
define('VOCABULARY_TOPIC', 'topic');
 ...
 * Header menu.
 */
define('MENU_HEADER', 'header');

/**
 * Lower (footer) menu, for some reason Drupal prepended 'menu-'.
 */
define('MENU_LOWER', 'menu-lower');

/**
 * Main menu.
 */
define('MENU_MAIN', MENU_HEADER);

/**
 * Tools for students menu.
 */
